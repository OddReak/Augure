...
describe('sprite de signes', () => {
  it('contient un <symbol> pour chacun des seize signes météo et des vingt-huit icônes d\'interface', () => {
    const attendus = [...IDS_SIGNES_METEO, ...ID_ICONES_INTERFACE];
    expect(attendus).toHaveLength(44);
  ...
  it('ne contient aucun symbole supplémentaire non catalogué', () => {
    ...
    expect(trouves).toHaveLength(44);
